...
p1 = input("Player 1 > ")
p2 = input ("Player 2 > " )
if (p1 == "R" or p1 == "P" or p1 == "S") and (p2 == "R" or p2 == "P" or p2 == "S"): ## this is the correct way to use longer logical checks, without the brackets, or & and are given differnt priotity orders when reading the statement.
  if p1 == "R" and p2 == "R":
